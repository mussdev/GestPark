...
namespace GestPark
{
    public partial class FormCreateFourn : Form
    {
        ...
        private void iconBtnSavedFourn_MouseHover(object sender, EventArgs e)
        {
            ToolTip ToolTipBtnSavedFourn = new ToolTip();
            ToolTipBtnSavedFourn.AutoPopDelay = 5000;
            ToolTipBtnSavedFourn.InitialDelay = 1000;
            ToolTipBtnSavedFourn.ReshowDelay = 500;
            ToolTipBtnSavedFourn.ShowAlways = true;
            ToolTipBtnSavedFourn.SetToolTip(this.iconBtnSavedFourn, "Enregistrer");
        }

        private void BtnJoindDoc_MouseHover(object sender, EventArgs e)
        {
            ToolTip ToolTipBtnJoindFourn = new ToolTip();
            ToolTipBtnJoindFourn.AutoPopDelay = 5000;
            ToolTipBtnJoindFourn.InitialDelay = 1000;
            ToolTipBtnJoindFourn.ReshowDelay = 500;
            ToolTipBtnJoindFourn.ShowAlways = true;
            ToolTipBtnJoindFourn.SetToolTip(this.BtnJoindDoc, "Joindre doc.");
        }
    }
}
